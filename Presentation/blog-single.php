    ...
    <section id="blog-single">
        <div class="container">
            ...
            <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                <div class="portfolio-slider-wrapper">
                    <ul id="portfolio-slider">
                        <li><img src="../Style/images/slider/s2.jpg" alt="" class="img-responsive"/></li>
                        <li><img src="../Style/images/slider/s1.jpg" alt="" class="img-responsive"/></li>
            ...
            <div class="about-auther">
                ...
                <hr>
                 <div class="well">
                    <img src="../Style/images/team/pic1.jpg" alt="alt" class="img-responsive">
                    <p>Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus.</p>
                </div>
            ...
            <div class="related-post">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../Style/images/blog/pic6.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../Style/images/blog/pic7.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="rel-post">
                        <a href="#">
                            <img src="../Style/images/blog/pic8.jpg" alt="" lass="img-responsive">
                            <div class="caption">
                    ...
                    <ul class="media-list">
                        <li class="media">
                            <a class="media-left" href="#">
                                <img src="../Style/images/team/pic5.jpg" alt="alt" class="img-responsive">
                            </a>
                        ...
                        <li class="media middle">
                         ...
                         <li class="media">
                                <a class="media-left" href="#">
                                    <img src="../Style/images/team/pic6.jpg" alt="alt" class="img-responsive">
                                </a>
                              <div class="media-body">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                    <div class="blog-sidebar">
                            ...
                            <ul>
                                <li class="col-md-12 col-sm-4"> 
                                    <div class="single-post">
                                        <a href="#"><img src="../Style/images/blog/pic7.jpg" alt="post-img" class="img-responsive"></a>
                                ...
                                <li class="col-md-12 col-sm-4"> 
                                    <div class="single-post">
                                        <a href="#"><img src="../Style/images/blog/pic6.jpg" alt="post-img" class="img-responsive"> </a>
                                         <p>Ellentesque eleifend condimentum tellus.</p>
                                        <span>3 days ago</span>
                                    </div>
                                </li>
                                <li class="col-md-12 col-sm-4"> 
                                    <div class="single-post">
                                        <a href="#"><img src="../Style/images/blog/pic10.jpg" alt="post-img" class="img-responsive"></a>
                                        <p>Ellentesque eleifend condimentum tellus.</p>
                                        <span>3 days ago</span>
                                    </div>
                                </li>
                        ...
                        <div class="photo-stream">
                            <h4>Photo stream</h4>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic6.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic7.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic8.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic9.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic10.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic11.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic12.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
                            <div class="b-stream">
                                <a href="#"><img src="../Style/images/blog/pic6.jpg" alt="pic1" class="img-responsive"></a>
                            </div>
